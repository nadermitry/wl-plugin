...
-->
  ...
  <div class="product-configuration">
    ...
    <div class="cable-config">
      ...
      <i class="fa-solid fa-house-chimney"></i> <a class=" mt-0 mb-0" target="_blank" href="<?php echo $result->location_url?>"> <?php echo sanitize_text_field($result->location_name); ?></a>
      </span>                 
            </div>

            <div class=" mt-0 mb-0">                
              <span class="bs-blog-date">
                <i class="fa-solid fa-location-dot"></i> <a  class=" mt-0 mb-0" target="_blank" href="https://www.google.com/maps?q=<?php echo $result->location_map?>"><?php echo sanitize_text_field($result->location_address);?></a>
               <!-- <i class="fa-solid fa-location-dot"></i> <a class=" mt-0 mb-0" target="_blank" href="https://www.google.com/maps?q=<?php echo $result->location_map?>">Location on Google Maps</a>-->
              </span>              
            </div>
  ...
  <ul id="list" class="list-group">
    ...
    <?php foreach ($gifts as $gift) : ?>
      ...
      <!--    <button class="xbutton" onclick="count_actions(<?php echo $gift->id?>,<?php echo $result->id?>,'purchase_count','<?php echo $gift->url?>')">Buy</button>-->
          <?php if ($isCurrentUser) :?>
            <button class="redbutton" onclick="remove_from_event(<?php echo $gift->id?>,<?php echo $result->id?>,<?php echo $gift->event_gift_id?>)">Remove</button>
          <?php endif ?>
        </div>
